...
cred = credentials.Certificate('thelouwinstitute-firebase-adminsdk-94lop-7f9c0ebfb8.json')
...
from_email = 'work.jerrywu@gmail.com'
to_email = 'thelouwinstitute@googlegroups.com'
subject = 'Join Us in Shaping a Better Future – Support The Louw Institute!'
